...
/// <summary>
/// The UI-host entry point for <see cref="CommonForwardedHeaders"/>.
/// </summary>
public static class CommonForwardedHeadersExtensions
{
    extension(IApplicationBuilder app)
    {
        /// <summary>
        /// Adopts the ingress's forwarded headers with the framework posture
        /// (<see cref="CommonForwardedHeaders.Create"/>). Call it FIRST in a server-rendered UI
        ...
        /// <see cref="CommonForwardedHeaders.DefaultHeaders"/> (For, Proto and Host).
        /// </param>
        /// <returns>The application builder, for chaining.</returns>
        public IApplicationBuilder UseCommonUiForwardedHeaders(ForwardedHeaders? headers = null) =>
            app.UseForwardedHeaders(CommonForwardedHeaders.Create(headers));
    }
}
