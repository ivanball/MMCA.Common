...
///   <item>The <c>PiiRedactor</c> helper masks <see cref="PiiAttribute"/>-marked members so an entity
///   carrying personal data can be written to a structured log or telemetry attribute without the data
///   subject's PII leaking in clear text.</item>
/// </list>
