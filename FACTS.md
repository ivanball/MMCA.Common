...
- **116 test methods across 42 abstract `*TestsBase` classes**, shipped once in the
...
- MMCA.Common's own build executes **152** of them (the methods of the bases its arch-tests
