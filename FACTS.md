...
_As of: 2026-09-12 (framework v1.195.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.195.0`** (MinVer-derived from the git tag at `main` HEAD).
