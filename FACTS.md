...
_As of: 2026-09-03 (framework v1.184.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.184.0`** (MinVer-derived from the git tag at `main` HEAD).
...
- **124 test methods across 47 abstract `*TestsBase` classes**, shipped once in the
...
- MMCA.Common's own build executes **197** of them (the methods of the bases its arch-tests
