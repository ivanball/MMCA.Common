...
_As of: 2026-09-21 (framework v1.207.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.207.0`** (MinVer-derived from the git tag at `main` HEAD).
