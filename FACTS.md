...
_As of: 2026-09-11 (framework v1.191.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.191.0`** (MinVer-derived from the git tag at `main` HEAD).
...
- **129 test methods across 49 abstract `*TestsBase` classes**, shipped once in the
...
- MMCA.Common's own build executes **244** of them (the methods of the bases its arch-tests
