...
_As of: 2026-07-04 (framework v1.104.2) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.104.2`** (MinVer-derived from the git tag at `main` HEAD).
