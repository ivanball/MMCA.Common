...
_As of: 2026-08-26 (framework v1.162.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.162.0`** (MinVer-derived from the git tag at `main` HEAD).
...
- **111 test methods across 39 abstract `*TestsBase` classes**, shipped once in the
...
- MMCA.Common's own build executes **134** of them (the methods of the bases its arch-tests
