...
_As of: 2026-07-24 (framework v1.125.1) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.125.1`** (MinVer-derived from the git tag at `main` HEAD).
