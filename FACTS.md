...
_As of: 2026-09-20 (framework v1.205.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.205.0`** (MinVer-derived from the git tag at `main` HEAD).
...
- **138 test methods across 53 abstract `*TestsBase` classes**, shipped once in the
...
- MMCA.Common's own build executes **281** of them (the methods of the bases its arch-tests
