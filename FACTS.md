...
_As of: 2026-07-04 (framework v1.103.1) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.103.1`** (MinVer-derived from the git tag at `main` HEAD).
