...
- **84 test methods across 28 abstract `*TestsBase` classes**, shipped once in the
...
- MMCA.Common's own build executes **45** of them (the methods of the bases its arch-tests
