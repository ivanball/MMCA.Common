...
_As of: 2026-09-15 (framework v1.202.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
- MMCA.Common's own build executes **264** of them (the methods of the bases its arch-tests
