...
_As of: 2026-07-11 (framework v1.112.1) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.112.1`** (MinVer-derived from the git tag at `main` HEAD).
...
## Architecture Decision Records — **44 (001-044)**
