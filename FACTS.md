...
_As of: 2026-07-03 (framework v1.100.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.100.0`** (MinVer-derived from the git tag at `main` HEAD).
...
## Architecture Decision Records — **36 (001-036)**
