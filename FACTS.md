...
_As of: 2026-07-09 (framework v1.108.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.108.0`** (MinVer-derived from the git tag at `main` HEAD).
