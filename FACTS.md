...
_As of: 2026-08-18 (framework v1.153.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.153.0`** (MinVer-derived from the git tag at `main` HEAD).
...
- MMCA.Common's own build executes **96** of them (the methods of the bases its arch-tests
