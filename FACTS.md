...
_As of: 2026-07-29 (framework v1.132.0) — **generated from source by `build/facts`; do not hand-edit the numbers below.**_
...
## Framework version
- **Current: `v1.132.0`** (MinVer-derived from the git tag at `main` HEAD).
